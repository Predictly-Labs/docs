...
| Pool Size   | Fee (2%) | Distributed to Winners |
| ----------- | -------- | ---------------------- |
| 10 MOVE     | 0.2 MOVE | 9.8 MOVE               |
| 100 MOVE    | 2 MOVE   | 98 MOVE                |
| 1,000 MOVE  | 20 MOVE  | 980 MOVE               |
| 10,000 MOVE | 200 MOVE | 9,800 MOVE             |
...
**Target:** Casual users and small groups
...
Predictly's dual revenue model—transaction fees + subscriptions—provides:

1. **Accessibility:** Free tier for casual users
2. **Scalability:** Revenue grows with platform usage
