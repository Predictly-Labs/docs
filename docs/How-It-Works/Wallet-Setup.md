...
Complete guide to setting up your wallet for Predictly.
...
1. Go to [wallet.nightly.app](https://wallet.nightly.app/)
2. Click **"Download"**
3. Select your browser (Chrome, Firefox, Edge)
4. Install extension
...
**Problem:** Wallet doesn't connect to Predictly

**Solutions:**

1. Refresh page
2. Unlock wallet extension
3. Switch to correct network (Movement Testnet)
...
**Problem:** Wallet shows wrong network

**Solution:**

1. Click wallet extension
2. Click network dropdown
3. Select "Movement Testnet"
4. Or add custom network (see above)
